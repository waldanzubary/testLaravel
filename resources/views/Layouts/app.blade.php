    ...
    <div class="flex">
        ...
        <div class="w-64 bg-base-200 min-h-screen shadow-lg">
            <div class="p-6">
                ...
                <nav class="mt-6">
                    <a href="/customers" class="block hover:bg-gray-700 hover:text-white p-3 rounded">Customers</a>
                    <a href="/contact" class="block  hover:bg-gray-700 hover:text-white p-3 rounded">Contacts</a>
                    <a href="/Warehouse" class="block  hover:bg-gray-700 hover:text-white p-3 rounded">Penjualan</a>
                    <a href="/sales/creates" class="block  hover:bg-gray-700 hover:text-white p-3 rounded">Transaksi</a>
                </nav>
            </div>
        </div>
